...
$classes = Flux::classes()
    ...
    ->add(match ($size) {
        default => 'h-14 py-2 text-base sm:text-sm leading-[1.375rem] rounded-lg',
        'sm' => 'h-10 py-1.5 text-sm leading-[1.125rem] rounded-md',
        'xs' => 'h-8 text-xs leading-[1.125rem] rounded-md',
    })
